            ...
            <div style="width: 890px; margin-bottom: 30px;">
                <div style="margin-left: 30px; border-bottom: solid 1px #bebebe">
                    <h4 style="margin: 20px 30px;">
                        <span style="color: #1d9cba;" class="glyphicon glyphicon-pencil"></span>&nbsp;&nbsp;作业
                    </h4>
                </div>
                <div>
                <#--     内容  -->
...
<script>
    function openExamWindow(userId,testPaperId,tutId){
        window.open('/account/courseWork?testPaperId=' + testPaperId + '&&studentId=' + userId +"&&tutId="+tutId, '_blank');
    }
</script>
