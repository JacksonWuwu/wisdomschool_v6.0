        ...
        <div class="navbar-container ace-save-state" id="navbar-container">
            ...
            <@shiro.hasRole name="sds_admin">
                <div class="navbar-header pull-left">
                    <a href="/teacher/course/${gdid}" class="navbar-brand">
                        <small>
                            <i class="fa fa-leaf"></i>
                           我的管理- ${gradename}- ${departmentname}
                        </small>
                    </a>
                </div>
            </@shiro.hasRole>
        ...
        <div id="sidebar" class="sidebar responsive ace-save-state sidebar-fixed sidebar-scroll">
            ...
            <div class="sidebar-shortcuts" id="sidebar-shortcuts">
                <#--<div class="sidebar-shortcuts-large" id="sidebar-shortcuts-large">
                    <button class="btn-success" onclick=window.open('/user/course/learn/${teacherCourse.id}')>
                        <i class="ace-icon fa fa-signal">课程界面</i>
                    </button>

                    <button class="btn-info" onclick=window.open('/user/topicList')>
