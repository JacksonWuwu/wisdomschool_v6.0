...
<div class="container-div clearfix">
    <div class="wrapper wrapper-content animated fadeInRight ibox-content">
        <form class="form-horizontal m" id="form-testPaperWork-edit">
...
<script type="text/javascript">
    ...
    $("#form-testPaperWork-edit").validate({
        rules: {
            headline: {
                required: true
            },
    ...
    function submitHandler() {
        if ($.validate.form()) {
            $.operate.saveModal(prefix + "/updateStateEdit", $('#form-testPaperWork-edit').serialize());
        }
    }
</script>
</body>
