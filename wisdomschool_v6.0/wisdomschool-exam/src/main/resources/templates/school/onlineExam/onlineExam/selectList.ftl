...
<script type="text/javascript">
    ...
    function getQuestionList() {
        ...
        $.ajax({
            type: 'POST',
            url: '/school/onlineExam/course/humanBuild?finalQid=' + finalQid + "&&score=" + titleTypeScore,
            dataType: 'json',
            success: function (data) {
                if (null != data && "" != data) {
                    qList = data;
    ...
    function showPaper() {
        ...
        $.ajax({
            type: "POST",
            url: "/school/onlineExam/course/buildTestStepTwo",
    ...
    function submitHandler() {
        ...
        if (questionid != "") {
            $.operate.saveModal("/school/onlineExam/course/addCoursePaper", $.param({
                'testPaperId': testid,
