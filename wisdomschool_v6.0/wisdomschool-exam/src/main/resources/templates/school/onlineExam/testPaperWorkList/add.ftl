...
<div class="container-div clearfix">
    <div class="wrapper wrapper-content animated fadeInRight ibox-content">
        <form class="form-horizontal m" id="form-testPaperWorkList-add">
...
<script type="text/javascript">
    ...
    let coursrId="${id}";
    $("#form-testPaperWorkList-add").validate({
        rules: {
            testName: {
                required: true
            },
    ...
    function submitHandler() {
        if ($.validate.form()) {
            $.operate.saveModal(prefix + "/add", $('#form-testPaperWorkList-add').serialize());
        }
    }
</script>
</body>
