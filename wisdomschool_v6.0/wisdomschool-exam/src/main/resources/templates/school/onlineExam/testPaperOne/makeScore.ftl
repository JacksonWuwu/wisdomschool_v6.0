...
<script>
    ...
    function submitsave() {
        if (confirm("您确定要提交并关闭吗？")) {
            $.ajax({
                type: "post",
                dataType: 'json',
                url: "/school/onlineExam/testPaperOne/saveScore?paperId=" + paperId + "&studentId=" + studentId,
                error: function (data) {
                    document.write("提交成功！");
                },
                success: function (data) {
    ...
    function doSum() {
        $.ajax({
            type: "post",
            dataType: 'json',
            url: "/school/onlineExam/testPaperOne/doSum?paperId=" + paperId + "&studentId=" + studentId,
            error: function (data) {
    ...
    function anwserchange(questionnum, questionid, questionscore, qscore) {
        ...
        $.ajax({
            type: "post",
            url: "/school/onlineExam/testPaperOne/saveStuScore?studentId=" + studentId + "&&questionid=" + questionid + "&&questionscore=" + score+"&&paperId"+paperId,
            error: function (data) {
