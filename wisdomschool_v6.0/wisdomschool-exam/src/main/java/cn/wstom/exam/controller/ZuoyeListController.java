...
@Controller
@RequestMapping("/school/onlineExam/zuoyeList")
public class ZuoyeListController extends BaseController {
    private String prefix = "school/onlineExam/zuoyeList";
