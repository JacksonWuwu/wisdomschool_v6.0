            ...
            <div class="col-menu-left">
                <div class="col-menu">
                    <div class="col-menu-top">
                        <img src="http://localhost:8081/storage/showCondensedPicture?fileId=${teacherCourse.thumbnailPath}">
                    </div>
                    <a href="/teacher/course/get/${teacherCourse.course.id}/1" class="col-menu-item"><i
                                class="fa fa-graduation-cap"></i> 课程信息</a>
                    <a href="javascript:void(0);" class="col-menu-item-pad"><i class="fa fa-file-archive-o"></i>
                        试卷列表</a>
                    <div class="item-sub">
                        <a href="/school/onlineExam/exam/${teacherCourse.course.id}"
                           class="col-menu-item">考试中心</a>
                        <a href="/school/onlineExam/course/getExamPaper/${teacherCourse.course.id}"
                           class="col-menu-item">试卷资源</a>
                        <a href="/school/onlineExam/examList/${teacherCourse.course.id}" class="col-menu-item">学生试卷</a>
                    </div>
                </div>
            </div>
        </div>
...
<div class="container-div inline-layout-container-div clearfix">
    <div id="inline-main-layout-container" style="width: 100%;height:600px;">
        <div data-options="region:'west',title:'${teacherCourse.course.name}',collapsible:false" style="width:20%;">
            <div class="col-menu-left">
                <div class="col-menu">
                    <div class="col-menu-top">
                        <img src="${storage}/showCondensedPicture?fileId=${teacherCourse.thumbnailPath}">
                    </div>
                    <a href="/teacher/course/get/${teacherCourse.course.id}/1" class="col-menu-item"><i
                                class="fa fa-graduation-cap"></i> 课程信息</a>
                    <#--<a href="/teacher/outline/get/${teacherCourse.course.id}" class="col-menu-item"><i-->
                                <#--class="fa fa-tasks"></i> 教学大纲</a>-->
                    <#--<a href="/teacher/chapter/get/${teacherCourse.course.id}" class="col-menu-item"><i-->
                                <#--class="fa fa-tasks"></i> 章节目录</a>-->
                    <#--<a href="/school/onlineExam/userTest/${teacherCourse.course.id}" class="col-menu-item"><i-->
                                <#--class="fa fa-book"></i> 课程作业</a>-->
                    <a href="javascript:void(0);" class="col-menu-item-pad"><i class="fa fa-sticky-note-o"></i>
                        课程考试</a>
                    <div class="item-sub">
                    ...
                    <a href="javascript:void(0);" class="col-menu-item-pad"><i class="fa fa-file-archive-o"></i>
                        课程资源</a>
                    <div class="item-sub">
                        <#--<a href="/recourse/videoresource/${teacherCourse.course.id}"-->
                           <#--class="col-menu-item">视频资源</a>-->
                        <#--<a href="/recourse/fileresource/${teacherCourse.course.id}"-->
                           <#--class="col-menu-item">课件资源</a>-->
                    ...
                    <#--<a href="/teacher/course/toStatis/${teacherCourse.course.id}/${teacherCourse.tid}"-->
                       <#--class="col-menu-item"><i class="fa fa-bar-chart"></i> 学习统计</a>-->
                    <#--<a href="" class="col-menu-item"><i class=" fa fa-pencil-square-o"></i> 测试中心</a>-->
                    <#--<a href="/teacher/course/${teacherCourse.course.id}/comment" class="col-menu-item"><i-->
    ...
    <div style="text-align: center">
        <a href="javascript:void(0);" class="btn btn-default"
           onclick="$.common.loadPage('main-page-container', '/school/onlineExam/course');"><i class="fa fa-reply"></i>
            返回我的课程</a>
    </div>
</div><!--/.container-div-->
<script type="text/javascript" src="/js/plugins/jquery-easyui/jquery.easyui.min.js"></script>
