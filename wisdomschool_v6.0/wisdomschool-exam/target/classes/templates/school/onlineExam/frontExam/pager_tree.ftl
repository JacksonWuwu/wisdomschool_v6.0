...
<div class="container-div">
    ...
    <div class="row">
        <div id="inline-outline-layout-container" style="width: 100%;height:600px;">
            <div data-options="region:'west',title:'作业目录', collapsible: false,tools: []"
        ...
        <script type="text/javascript">
            ...
            function initTree() {
                let url = "/school/onlineExam/frontExam/studentPagerTree/${cid}";
                let options = {
                    id: "outline-tree",
                    url: url,
                    expandLevel: 0,
            ...
            function zTreeOnClick(event, treeId, treeNode) {
                ...
                if (flag) {
                    ...
                    treeNode.name;
                    $.common.loadPage('outlineArea', "/school/onlineExam/frontExam/studentPagerContent/" + ${cid} + "/" + testPagerId + "/" + clbumId);
                }
            };
