...
<div class="container-div clearfix">
    <div class="wrapper wrapper-content animated fadeInRight ibox-content">
        <form class="form-horizontal m" id="form-testPaperWorkList-edit">
<#--            <input id="id" name="id"-->
...
<script type="text/javascript">
    ...
    $("#form-testPaperWorkList-edit").validate({
        rules: {
            headline: {
                required: true
            },
    ...
    function submitHandler() {
        if ($.validate.form()) {
            $.operate.saveModal(prefix + "/edit", $('#form-testPaperWorkList-edit').serialize());
        }
    }
</script>
</body>
