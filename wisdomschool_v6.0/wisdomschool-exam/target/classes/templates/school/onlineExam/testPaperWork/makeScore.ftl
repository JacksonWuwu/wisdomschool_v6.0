...
<script>
    ...
    function submitsave() {
        if (confirm("您确定要提交并关闭吗？")) {
            $.ajax({
                type: "post",
                dataType: 'json',
                url: "/school/onlineExam/testPaperWork/saveScore?paperId=" + paperId + "&studentId=" + studentId,
                error: function (data) {
                    document.write("提交成功！");
                },
                success: function (data) {
    ...
    function doSum() {
        $.ajax({
            type: "post",
            dataType: 'json',
            url: "/school/onlineExam/testPaperWork/doSum?paperId=" + paperId + "&studentId=" + studentId,
            error: function (data) {
    ...
    function anwserchange(questionnum, questionid, questionscore, qscore) {
        ...
        $.ajax({
            type: "post",
            url: "/school/onlineExam/testPaperWork/saveStuScore?studentId=" + studentId + "&&questionid=" + questionid + "&&questionscore=" + score+"&&paperId"+paperId,
            error: function (data) {
