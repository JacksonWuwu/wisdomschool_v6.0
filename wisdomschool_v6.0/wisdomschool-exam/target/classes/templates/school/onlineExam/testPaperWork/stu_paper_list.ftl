...
<script type="text/javascript">
    ...
    $(function () {
        let options = {
            url: prefix + "/studentPaper/list/${cid}",
...
<#--                        </@shiro.hasPermission>-->
    ...
    function showStuPaper(idAndNum) {
        ...
        $.modal.open('学生考试', "/school/onlineExam/testPaperWork/showStuPaper?id=${id}&&userId=" + userId,  saveCallback);
    ...
    function openwindow(idAndNum) {
        ...
        window.open('/school/onlineExam/testPaperWork/makeScore?id=' + id + '&&stuNum=' + stuNum, '_blank');
    }
    ...
    function checkPaper(content) {
        ...
        var id=idAndStuNum[0];
        var stuNum =idAndStuNum[1];
        var url='/school/onlineExam/testPaperWork/checkStuPaper?id='+id+'&stuNum='+stuNum
    ...
    function showPaper(content) {
        ...
        var id=idAndStuNum[0];
        var stuNum =idAndStuNum[1];
        var url='/school/onlineExam/testPaperWork/showStuPaper?id='+id+'&stuNum='+stuNum
        url=url+"&token="+localStorage.getItem("token")
        window.open(url,'_blank');
    }
    function removePaper(con){
        ...
        $.modal.confirm("确认要删除?", function () {
            ...
            $.operate.submit("/school/onlineExam/testPaperWork/studentPaper/remove", "post", "json", data, true, function (result) {
