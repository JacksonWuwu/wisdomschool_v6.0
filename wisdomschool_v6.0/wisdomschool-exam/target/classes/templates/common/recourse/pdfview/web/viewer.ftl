...
<head>
    ...
    <link rel="stylesheet" href="/js/recourse/pdfview/web/viewer.css">
    <!-- This snippet is used in production (included from viewer.ftl) -->
    <link rel="resource" type="application/l10n"
          href="/js/recourse/pdfview/web/locale/locale.properties">
    <link rel="icon" type="image/x-icon" href="/js/recourse/pdfview/web/images/pdf-icon.png"/>
    <!-- 自定义的提示样式（类似于主页的加载提示） -->
    <style type="text/css">
        .pdf-modal {
            display: none;
...
<script src="/js/recourse/pdfview/build/pdf.js"></script>
<script src="/js/recourse/pdfview/web/viewer.js"></script>
