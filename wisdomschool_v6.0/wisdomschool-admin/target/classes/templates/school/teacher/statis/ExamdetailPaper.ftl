...
<script type="text/javascript">
    ...
    $(function () {
        let options = {
            url: "/teacher/statis/showExamDetail/${userId}/${tcId}",
            removeUrl: "/school/onlineExam/userExam/remove",
            modalName: "试卷",
            columns: [
                {
                    checkbox: true
...
<#--                            </@shiro.hasPermission>-->
    ...
    function showStuPaper(idAndNum) {
        ...
        $.modal.open('学生作业', "/school/onlineExam/testPaperOne/showStuPaper?id=" + id + "&&userId=" + userId,  saveCallback);
