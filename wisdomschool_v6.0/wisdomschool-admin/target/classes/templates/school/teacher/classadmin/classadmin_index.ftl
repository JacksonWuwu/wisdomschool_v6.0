                        ...
                        <div class="row">
                            <div class="pagerContent pic-list">
                                <div class="pagerMainContent" style="display: none;">
                                    <a key="id"  class="pic-list-constant-item" onclick="SclickLoad(event)">
                                        <div class="">
                                            <div class="cover-info">
                                                <i class="fa fa-list-ul"></i> &nbsp;<h4 key="name"></h4>
<#--                                                <div>-->
...
<script type="text/javascript">
    ...
    function initPagerEvent() {
        ...
        let contentItem = [{
            key: 'id' ,
            replace: 'redirect:/classadmin/role/{%}',
            attr: 'href'
        }, {
            key: 'name'}
            ];
