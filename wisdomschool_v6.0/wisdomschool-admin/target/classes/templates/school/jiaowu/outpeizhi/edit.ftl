            ...
            <div class="content-list-item common-shadow wow fadeInUp">
                <div class="content">
                    ...
                    <div class="form-group">
                        <div class="">
                            <textarea name="content" id="outpeizhi"
                                      rows="40">${outpeizhi.content}</textarea>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    $(function () {
        ckeditor1 = CKEDITOR.replace('outpeizhi', {
            height: 800,
    ...
    function submitOutlineForm() {
        let content = CKEDITOR.instances.outpeizhi.document.getBody().getText();
        ...
        if ($.validate.form()) {
            $.operate.postJson(prefix + "/save/${tcId}", {
                tcId: $("#tcId").val(),
                content: CKEDITOR.instances.outpeizhi.getData()
