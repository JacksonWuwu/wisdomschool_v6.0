...
<#--			<@shiro.hasPermission name="system:role1:add">-->
				<a class="btn btn-success" onclick="$.operate.add()">
					<i class="fa fa-plus"></i> 新增
				</a>
<#--			</@shiro.hasPermission>-->
<#--			<@shiro.hasPermission name="system:role1:edit">-->
...
<#--			<@shiro.hasPermission name="system:role1:export">-->
...
<#--					</@shiro.hasPermission>-->
					...
					if (row.id > 1)
<#--					<@shiro.hasPermission name="system:role1:remove">-->
