define(function (require, exports, module) {
    ...
    $.jphiz = function (box, options) {
        ...
        phizItem = $.format("<span><a href='javascript:;' title='{0}'><img class='_jphiz_icon' src='{1}'/></a></span>");
        ...
        self.bind("click", function () {
            if (Phiz.isHidden()) {
                ...
                $.each(Phiz.phizs, function (k, v) {
                    $("[view='c-phizs']", Phiz.box()).append(phizItem(k, opts.base + "/image/emoticon/" + v + ".gif'"));
                });
