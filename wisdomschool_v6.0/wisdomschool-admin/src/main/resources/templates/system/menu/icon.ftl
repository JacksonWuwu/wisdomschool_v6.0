...
<div class="ico-list">
    ...
    <i class="fa fa-sysUser" aria-hidden="true"></i>

    <i class="fa fa-sysUser-circle" aria-hidden="true"></i>

    <i class="fa fa-sysUser-circle-o" aria-hidden="true"></i>

    <i class="fa fa-sysUser-o" aria-hidden="true"></i>

    <i class="fa fa-sysUser-plus" aria-hidden="true"></i>

    <i class="fa fa-sysUser-secret" aria-hidden="true"></i>

    <i class="fa fa-sysUser-times" aria-hidden="true"></i>
