...
<div id="divpx2">
    <div class="col-sm-12 select-table table-striped" style="width: 400px;">
...
<script type="text/javascript">
    ...
    function TinitPagerEvent() {
        ...
        let TpagerOptions = {
            loadURL: 'http://lxweixin.free.idcfengye.com/wx/course/list?studentId='+studentId,
            item: TcontentItem
        };
...
<script>
    ...
    function initPaper() {
        ...
        $.ajax({
            type: "get",
            dataType: 'json',
            url: "http://lxweixin.free.idcfengye.com/wx/exam/chapterTest/startCoursePaper?paperId=" + paperId + "&&studentId=" + studentId,
    ...
    function saveOrUpdateAnswer() {
        ...
        $.ajax({
            type: "post",
            url: "http://lxweixin.free.idcfengye.com/wx/exam/chapterTest/saveChapterWorkAnswer",
            dataType: "json",
