...
<script type="text/javascript">
    ...
    function submitHandler() {
        ...
        if (stuUserId == "") {
            ...
            //  更新每个学生试卷
            // $.operate.saveModal(prefix + "/addluckfabu", $.param({
            //     "id": voteId,
            //     // "time": time,
            ...
            //     "userId": userId,
            // }));
            <#--$.modal.open('随机提问', "/teacher/vote/addluckfabu/${tcid}?userId=" + userId);-->
            window.open("/teacher/vote/addluckfabu/${tcid}?userId=" + userId)
        }
    }
</script>
</body>
