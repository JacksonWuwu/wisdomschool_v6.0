...
<#--    </div>-->
<#--</div>-->
<#--&lt;#&ndash;<#include "/common/stretch.ftl"/>&ndash;&gt;-->
...
<#--            }-->
<#--            &lt;#&ndash;else if (treeNode.pId === 2) {&ndash;&gt;-->
<#--            &lt;#&ndash;    opt = '<btn class="btn btn-primary" style="  width:100px;\n' +&ndash;&gt;-->
<#--            &lt;#&ndash;        '     text-align:center;\n' +&ndash;&gt;-->
<#--            &lt;#&ndash;        '     line-height:100%;\n' +&ndash;&gt;-->
<#--            &lt;#&ndash;        '     padding:0.3em;\n' +&ndash;&gt;-->
<#--            &lt;#&ndash;        '     font:16px Arial,sans-serif bold;\n' +&ndash;&gt;-->
<#--            &lt;#&ndash;        '     font-style:normal;\n' +&ndash;&gt;-->
<#--            &lt;#&ndash;        '     text-decoration:none;\n' +&ndash;&gt;-->
<#--            &lt;#&ndash;        '     margin:2px;\n' +&ndash;&gt;-->
<#--            &lt;#&ndash;        '     vertical-align:text-bottom;\n' +&ndash;&gt;-->
<#--            &lt;#&ndash;        '     zoom:1;\n' +&ndash;&gt;-->
<#--            &lt;#&ndash;        '     outline:none;\n' +&ndash;&gt;-->
<#--            &lt;#&ndash;        '     font-size-adjust:none;\n' +&ndash;&gt;-->
<#--            &lt;#&ndash;        '     font-stretch:normal;\n' +&ndash;&gt;-->
<#--            &lt;#&ndash;        '     border-radius:50px;\n' +&ndash;&gt;-->
<#--            &lt;#&ndash;        '     box-shadow:0px 1px 2px rgba(0,0,0,0.2);\n' +&ndash;&gt;-->
<#--            &lt;#&ndash;        '     text-shadow:0px 1px 1px rgba(0,0,0,0.3);\n' +&ndash;&gt;-->
<#--            &lt;#&ndash;        '     color:#fefee9;\n' +&ndash;&gt;-->
<#--            &lt;#&ndash;        '     border:0.2px solid #2299ff;\n' +&ndash;&gt;-->
<#--            &lt;#&ndash;        '     background-repeat:repeat;\n' +&ndash;&gt;-->
<#--            &lt;#&ndash;        '     background-size:auto;\n' +&ndash;&gt;-->
<#--            &lt;#&ndash;        '     background-origin:padding-box;\n' +&ndash;&gt;-->
<#--            &lt;#&ndash;        '     background-clip:padding-box;\n' +&ndash;&gt;-->
<#--            &lt;#&ndash;        '     background-color:#3399ff;\n' +&ndash;&gt;-->
<#--            &lt;#&ndash;        '     background: linear-gradient(to bottom, #eeeff9 0%,#3399ff 100%);margin: 0 10px;float: right;" onclick="window.open(\'/recourse/demo/' + treeNode.rid + '\')">预览</btn>';&ndash;&gt;-->
<#--            &lt;#&ndash;}&ndash;&gt;-->
...
<#--                    '     background-clip:padding-box;\n' +-->
<#--                    '     background-color:#3399ff;\n' +-->
<#--                    '     background: linear-gradient(to bottom, #eeeff9 0%,#3399ff 100%);\nmargin: 0 10px;float: right;" onclick="downLoad(\'' + treeNode.rid + '\')">下载</btn>';-->
<#--            }-->
<#--            aObj.append(delStr);-->
<#--            aObj.append(opt);-->
<#--        }-->
