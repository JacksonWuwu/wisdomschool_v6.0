...
import cn.wstom.storage.feign.AdminService;
import cn.wstom.storage.server.enumeration.Data;
import cn.wstom.storage.server.enumeration.JwtConstant;
import cn.wstom.storage.server.pojo.PageDomain;
import cn.wstom.storage.server.pojo.SysUser;
import cn.wstom.storage.server.pojo.TableDataInfo;
import cn.wstom.storage.server.pojo.TableSupport;
import cn.wstom.storage.server.util.JwtUtils;
import cn.wstom.storage.server.util.ServletUtils;
import cn.wstom.storage.server.util.StringUtil;
...
public abstract class BaseController {
    ...
    protected void startPage() {
        try {
            ...
            log.info("这是pageNum{}",pageNum);
            log.info("这是pageSize{}",pageSize);
